class BankAccount {
  ...
  void withdraw(double amount) {
    ...
    if(amount <= 0) throw Exception('The  amount must be positive.');
    _balance -= amount;
  }
...
class Bank {
    ...
    BankAccount createAccount(BankAccount newAccouont) {
      if(_isValidId(newAccouont._accountId)){
        ...
        throw Exception('Account with ID ${newAccouont._accountId} already exists');
      }
    }
...
void main() {
  ...
  try {
    ...
    //myBank.createAccount(BankAccount(200, 'gechty'));
  } catch (e) {
